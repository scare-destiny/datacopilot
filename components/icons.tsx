...
export const DataCopilotIcon = ({ size = 17 }) => {
	return (
		<svg
			width={size}
			height={size}
			...
			style={{ color: 'currentcolor' }}
		>
			{/* Main shape - combines database and paper airplane */}
			<g transform='translate(100,100) rotate(-15)'>
				...
				{/* Paper airplane body doubling as database body */}
				<path
					d='M-45,-30 L-45,20 A45,15 0 0,0 45,20 L45,-30 A45,15 0 0,1 -45,-30'
					fill='currentColor'
					opacity='0.7'
				/>

				{/* Bottom oval */}
				<ellipse cx='0' cy='20' rx='45' ry='15' fill='currentColor' opacity='0.9' />

				{/* Playful wing accent */}
				<path
					d='M-20,-30 L45,-40 L35,-15'
					fill='currentColor'
					opacity='0.5'
					stroke='currentColor'
					strokeWidth='2'
			...
			<g stroke='currentColor' strokeWidth='2' strokeLinecap='round' opacity='0.3'>
				...
				<line x1='35' y1='130' x2='15' y2='130' />
